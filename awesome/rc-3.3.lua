...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "d", function (c) c:lower()         end),
    awful.key({ modkey,           }, "u", function (c) c:raise()         end),
...
clientbuttons = awful.util.table.join(
                   --[[ awful.button({ }, 6, function(c) 
                        --awful.util.spawn("/home/justin/bin/shiftctrltab") 
                        root.fake_input('key_press', "Shift") 
                        root.fake_input('key_press', "Control") 
                        root.fake_input('key_press', "Tab") 
                        root.fake_input('key_release', "Tab") 
                        root.fake_input('key_release', "Control") 
                        root.fake_input('key_release', "Shift") 
                    end),
                    awful.button({ }, 7, function(c) 
                        awful.util.spawn("/home/justin/bin/ctrltab") 
                    end),]]--
                    awful.button({ }, 13, awful.tag.viewnext),
                    awful.button({ }, 14, awful.tag.viewprev),
                    awful.button({ }, 15, awful.tag.viewprev)
