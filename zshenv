...
#
PROFILE_DIR=~/Profile
COMMON_PATH="$HOME/bin:$HOME/Profile/bin:$PATH:/usr/bin/wrappers:/usr/local/bin:/usr/bin:/bin"
...
PATH="$LOCAL_PYTHON_PATH:$LOCAL_PERL5_PATH:$ENCODE_PATH:$COMMON_PATH:$ROOT_PATH:$SVN_PATH:$MYSQL_PATH:$POSTFIX:$PHP_PATH:$SNAP_PATH"
PATH="$PATH:$APACHE_PATH:$LAMEPATH:$FFMPEGPATH:$USER_PATH:$NAGIOS_PATH:$LOCAL_NODE_PATH:$NPM_PATH"
