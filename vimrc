...
" ===========================================
" VS Code / Cursor specific configuration
" ===========================================
if exists('g:vscode')
  " Skip heavy plugins - Cursor handles these
  ...
  " Your indent settings (Cursor respects these)
  set autoindent
  set smartindent
  set tabstop=4
  set softtabstop=4
  ...
  " Comments (replaces NERDCommenter if you use it)
  ...
  " Skip the rest of vimrc for VS Code
  finish
else
  ...
  "  endif
    ...
    if has("autocmd")
      ...
      au FileType yaml setlocal ts=2 sts=2 sw=2 expandtab nosmarttab preserveindent
    ...
    let g:Perl_Email           = 'Justin.Hoppensteadt@paradigm.co'
    let g:Perl_Company         = 'Paradigm'

    let g:BASH_AuthorName      = 'Justin Hoppensteadt'
    let g:BASH_AuthorRef       = 'JH'
    let g:BASH_Email           = 'Justin.Hoppensteadt@paradigm.co'
    let g:BASH_Company         = 'Paradigm'

    let g:Lua_AuthorName      = 'Justin Hoppensteadt'
    let g:Lua_AuthorRef       = 'JH'
    let g:Lua_Email           = 'Justin.Hoppensteadt@paradigm.co'
    let g:Lua_Company         = 'Paradigm'

    let g:spec_chglog_packager = 'Justin Hoppensteadt <justin.hoppensteadt@paradigm.co>'
    ...
    "
    " Copilot
    map <silent> <s-tab> <Esc>:Copilot<CR>
    imap <silent> <s-tab> <Esc>:Copilot<CR>
    "-------------------------------------------------------------------------------
